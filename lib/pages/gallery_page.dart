        ...
        child: GridView.builder(
          ...
          itemBuilder: (ctx, i) {
            ...
            return GestureDetector(
              onTap: () => showDialog(context: context, builder: (_) => Dialog(child: Image.file(File(n.imagePath!)))),
              child: ClipRRect(borderRadius: BorderRadius.circular(12), child: Image.file(File(n.imagePath!), fit: BoxFit.cover)),
            );
          },
        ),
      ),
